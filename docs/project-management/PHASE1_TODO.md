...
/* Component styles */
.btn-primary {
  @apply bg-primary-500 hover:bg-primary-600 rounded-xl px-6 py-3 font-semibold text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg;
}

.card {
  @apply rounded-2xl border border-neutral-100 bg-white p-6 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl;
}
```
