    ...
    <div class="mx-auto max-w-6xl">
      <div class="grid gap-8 lg:grid-cols-4">
        ...
        <div class="lg:col-span-3">
          <Card class="prose prose-lg blog-content max-w-none">
            <Content />
          </Card>
...
_Reading progress bar telah diperbaiki untuk hanya menghitung progress dari konten artikel yang spesifik!_
