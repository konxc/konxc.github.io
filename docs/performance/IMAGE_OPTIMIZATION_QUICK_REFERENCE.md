...
```astro
<!-- ❌ Current (Heavy) -->
<img src="/logo-konxc.jpg" alt="KonXC" class="logo-image h-8 w-8" />
```
...
```astro
<!-- Replace current Logo.astro with OptimizedLogo.astro --><!-- Use priority=true for above-the-fold logos -->
