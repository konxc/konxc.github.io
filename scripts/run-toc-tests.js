...
class TOCTestRunner {
  ...
  async runTOCTests() {
    ...
    try {
      ...
      console.log(
        `${links.length > 0 ? "✅" : "❌"} TOC Links Generated (${links.length} links)`,
      );
      ...
      if (links.length > 0) {
        ...
        console.log(
          `${href?.startsWith("#heading-") ? "✅" : "❌"} Links Have Correct Href Format`,
        );
        console.log(
          `${text?.length > 0 ? "✅" : "❌"} Links Have Text Content`,
        );
      }
      ...
      if (h3Links.length > 0) {
        ...
        console.log(
          `${hasIndentation ? "✅" : "❌"} H3 Has Proper Indentation`,
        );
      }
