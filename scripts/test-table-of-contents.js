      ...
      const tests = [
        ...
        },
        {
          ...
          test: async () => {
            ...
            return (
              h2Links.length > 0 || h3Links.length > 0 || h4Links.length > 0
            );
          },
        },
        {
          ...
          test: async () => {
            ...
            return (
              h3Style.marginLeft !== "0px" || h3Style.paddingLeft !== "0px"
            );
          },
        },
        {
          ...
          test: async () => {
            ...
            // Check if collapsed
            const classesAfterClick = await this.page.evaluate(
              (el) => el?.className,
              tocNav,
            );
            ...
            const classesAfterSecondClick = await this.page.evaluate(
              (el) => el?.className,
              tocNav,
            );
            const isExpandedAgain =
              classesAfterSecondClick?.includes("expanded");
        ...
        },
        {
          ...
          test: async () => {
            ...
            const firstLinkClasses = await this.page.evaluate(
              (el) => el?.className,
              links[0],
            );
        ...
        },
        {
          ...
          test: async () => {
            ...
            await this.page.goto(
              `${this.baseUrl}/blog/2024-01-29-mengatasi-empty-chunk-warning-astro`,
              {
                waitUntil: "networkidle0",
              },
            );
      ...
      const interactions = [
        ...
        },
        {
          ...
          test: async () => {
            ...
            const firstLinkActive = await this.page.evaluate(
            ...
            const secondLinkActive = await this.page.evaluate(
              (el) => el?.className.includes("active"),
              links[1],
            );

            const firstLinkInactive = await this.page.evaluate(
              (el) => !el?.className.includes("active"),
              links[0],
            );
