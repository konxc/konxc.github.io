    ...
    const mockComments = [
      {
        ...
        content:
          "Artikel yang sangat informatif! Terima kasih sudah berbagi insights tentang Tailwind CSS v4.",
        ...
        replies: [
          {
            ...
            content:
              "Terima kasih Ahmad! Senang artikel ini bermanfaat untuk Anda.",
      ...
      },
      {
        ...
        content:
          "Saya sudah mencoba implementasi path aliases di project Astro saya. Sangat membantu untuk maintainability!",
